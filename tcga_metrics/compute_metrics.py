...
def compute_metrics(input_participant,  gold_standards_dir, cancer_types, participant, community, out_path):
    ...
    for cancer in cancer_types:
        ...
        assessment_data = {'agentname': participant, 'x': TPR, 'y': acc, 'e': 0, 'cancer_type': cancer}
...
if __name__ == '__main__':
    ...
    parser.add_argument("-p", "--participant_name", help="name of the agent used for prediction", required=True)
