...
"""
    INFO:
    This module contains functions that generate JSON objects with structure compatible with the iEchor 
...
"""
    ...
    - participant_name - name/OEB-id of the agent which generated the dataset
...
"""
    ...
    - participant_name - name/OEB-id of the agent which is evaluated in this assessment
